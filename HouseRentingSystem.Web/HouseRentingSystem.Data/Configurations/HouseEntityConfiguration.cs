namespace HouseRentingSystem.Data.Configurations
{
    ...
    public class HouseEntityConfiguration : IEntityTypeConfiguration<House>
    {
        public void Configure(EntityTypeBuilder<House> builder)
        {
            ...
            builder.HasData(this.CreateHouses());
        }

        private House[] CreateHouses()
        {
            ...
            house = new House
            {
                ...
                CategoryId = 3,
                AgentId = Guid.Parse("BE38A3D1-5835-4D2D-83FA-CA69DCBA5FB8"),
                RenterId = Guid.Parse("85198CAA-C7E6-466F-2C80-08DBFF165C44")
            };
            houses.Add(house);
