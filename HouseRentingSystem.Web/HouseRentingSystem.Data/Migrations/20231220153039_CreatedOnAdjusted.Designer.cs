...
namespace HouseRentingSystem.Data.Migrations
{
    ...
    [Migration("20231220153039_CreatedOnAdjusted")]
    partial class CreatedOnAdjusted
    {
            ...
            modelBuilder.Entity("HouseRentingSystem.Data.Models.House", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b12a724b-23d4-4034-bf95-3a2130df679d"),
                            Address = "North London, UK (near the border)",
                            AgentId = new Guid("be38a3d1-5835-4d2d-83fa-ca69dcba5fb8"),
                            CategoryId = 3,
                            CreatedOn = new DateTime(2023, 12, 20, 15, 30, 39, 81, DateTimeKind.Utc).AddTicks(6745),
                        ...
                        new
                        {
                            Id = new Guid("a69d3dd8-af9f-4ca5-b16d-6959da6c7fcb"),
                            Address = "Near the Sea Garden in Burgas, Bulgaria",
                            AgentId = new Guid("be38a3d1-5835-4d2d-83fa-ca69dcba5fb8"),
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 12, 20, 15, 30, 39, 81, DateTimeKind.Utc).AddTicks(6763),
                        ...
                        new
                        {
                            Id = new Guid("40909151-fdb5-494a-b486-7a1d1e2bf043"),
                            Address = "Boyana Neighbourhood, Sofia, Bulgaria",
                            AgentId = new Guid("be38a3d1-5835-4d2d-83fa-ca69dcba5fb8"),
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 12, 20, 15, 30, 39, 81, DateTimeKind.Utc).AddTicks(6773),
