...
namespace HouseRentingSystem.Data.Migrations
{
    ...
    [Migration("20231225165807_ApplicationUserFirstNameAndLastName")]
    partial class ApplicationUserFirstNameAndLastName
    {
            ...
            modelBuilder.Entity("HouseRentingSystem.Data.Models.House", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("17a94d6e-c530-4cc6-a9a3-cf183541def4"),
                            Address = "North London, UK (near the border)",
                            AgentId = new Guid("be38a3d1-5835-4d2d-83fa-ca69dcba5fb8"),
                            CategoryId = 3,
                            CreatedOn = new DateTime(2023, 12, 25, 16, 58, 7, 23, DateTimeKind.Utc).AddTicks(1108),
                        ...
                        new
                        {
                            Id = new Guid("370b38cc-7a12-4291-a2cc-086d52fa964e"),
                            Address = "Near the Sea Garden in Burgas, Bulgaria",
                            AgentId = new Guid("be38a3d1-5835-4d2d-83fa-ca69dcba5fb8"),
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 12, 25, 16, 58, 7, 23, DateTimeKind.Utc).AddTicks(1123),
                        ...
                        new
                        {
                            Id = new Guid("382618aa-730c-49c6-9935-b88b95b9bb95"),
                            Address = "Boyana Neighbourhood, Sofia, Bulgaria",
                            AgentId = new Guid("be38a3d1-5835-4d2d-83fa-ca69dcba5fb8"),
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 12, 25, 16, 58, 7, 23, DateTimeKind.Utc).AddTicks(1125),
