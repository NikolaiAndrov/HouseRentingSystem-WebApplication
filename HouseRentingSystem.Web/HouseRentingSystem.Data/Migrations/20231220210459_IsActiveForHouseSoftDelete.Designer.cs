...
namespace HouseRentingSystem.Data.Migrations
{
    ...
    [Migration("20231220210459_IsActiveForHouseSoftDelete")]
    partial class IsActiveForHouseSoftDelete
    {
            ...
            modelBuilder.Entity("HouseRentingSystem.Data.Models.House", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ab6b1e2d-1f83-4e68-af09-ffdfd8da45f3"),
                            Address = "North London, UK (near the border)",
                            AgentId = new Guid("be38a3d1-5835-4d2d-83fa-ca69dcba5fb8"),
                            CategoryId = 3,
                            CreatedOn = new DateTime(2023, 12, 20, 21, 4, 59, 587, DateTimeKind.Utc).AddTicks(3772),
                        ...
                        new
                        {
                            Id = new Guid("9f4f2d90-71cf-4fe3-9de2-11d8128c2f7b"),
                            Address = "Near the Sea Garden in Burgas, Bulgaria",
                            AgentId = new Guid("be38a3d1-5835-4d2d-83fa-ca69dcba5fb8"),
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 12, 20, 21, 4, 59, 587, DateTimeKind.Utc).AddTicks(3786),
                        ...
                        new
                        {
                            Id = new Guid("9fd5c9cd-4b58-4646-a04f-f60414c08055"),
                            Address = "Boyana Neighbourhood, Sofia, Bulgaria",
                            AgentId = new Guid("be38a3d1-5835-4d2d-83fa-ca69dcba5fb8"),
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 12, 20, 21, 4, 59, 587, DateTimeKind.Utc).AddTicks(3788),
