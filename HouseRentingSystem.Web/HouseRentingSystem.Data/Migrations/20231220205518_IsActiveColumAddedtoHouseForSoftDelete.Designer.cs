...
namespace HouseRentingSystem.Data.Migrations
{
    ...
    [Migration("20231220205518_IsActiveColumAddedtoHouseForSoftDelete")]
    partial class IsActiveColumAddedtoHouseForSoftDelete
    {
            ...
            modelBuilder.Entity("HouseRentingSystem.Data.Models.House", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("37687378-37c9-4e98-8bcc-b13aae063b94"),
                            Address = "North London, UK (near the border)",
                            AgentId = new Guid("be38a3d1-5835-4d2d-83fa-ca69dcba5fb8"),
                            CategoryId = 3,
                            CreatedOn = new DateTime(2023, 12, 20, 20, 55, 18, 665, DateTimeKind.Utc).AddTicks(3312),
                        ...
                        new
                        {
                            Id = new Guid("b0f65032-4ce4-44ab-94d9-e0d8b37f624c"),
                            Address = "Near the Sea Garden in Burgas, Bulgaria",
                            AgentId = new Guid("be38a3d1-5835-4d2d-83fa-ca69dcba5fb8"),
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 12, 20, 20, 55, 18, 665, DateTimeKind.Utc).AddTicks(3327),
                        ...
                        new
                        {
                            Id = new Guid("7cf25bd4-192a-48ff-a9ea-05072d7457ce"),
                            Address = "Boyana Neighbourhood, Sofia, Bulgaria",
                            AgentId = new Guid("be38a3d1-5835-4d2d-83fa-ca69dcba5fb8"),
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 12, 20, 20, 55, 18, 665, DateTimeKind.Utc).AddTicks(3329),
